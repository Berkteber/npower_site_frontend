          ...
          <div className="col-lg-6 col-12 contact-left">
            ...
            <form className="p-0" onSubmit={handleSubmit}>
              <div className="form-group flex-column gap-0 p-0">
                <input type="text" className="company-input mb-20" name="name" id="name" placeholder="Ad-Soyad" value={formData.name} onChange={handleChange} required />
                ...
                <input type="text" className="phone-input mb-20" name="phone" id="phone" placeholder="Telefon" value={formData.phone} onChange={handleChange} required />
                <input type="text" className="message-input mb-20" name="message" id="message" placeholder="Sorularınız" value={formData.message} onChange={handleChange} required />
              </div>
