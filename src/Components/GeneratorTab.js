...
const GeneratorTab = ({ tabs, tableData }) => {
  ...
  const [groupSize, setGroupSize] = useState(4); // Varsayılan olarak 4'lü gruplar

  // Ekran genişliğine bağlı olarak groupSize'ı güncelle
  useEffect(() => {
  ...
  // Ekran genişliğine bağlı olarak grup oluşturma
  const groupedTabs = [];
                    ...
                    <div className="table-details-heading">
                      <div>
                        ...
                        <div className="tab-details-features">
                          <p>
                            <span>Backup Power:</span> {selectedDetail.yedekGuc}
                          </p>
                          <p>
                            <span>Primary Power:</span> {selectedDetail.birincilGuc}
                          </p>
                          <p>
                            <span>Hz:</span> {selectedDetail.hz}
                          </p>
                        </div>
                      </div>
                      <Link
                      ...
                      >
                        {pathname.includes("/portable-generator") ? "Buy Now" : "Download Catalog"}
                      </Link>
                    </div>
                    <div className="row">
