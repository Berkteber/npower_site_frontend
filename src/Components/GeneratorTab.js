                    ...
                    <div className="table-details-heading">
                      <div>
                        ...
                        <div className="tab-details-features">
                          <p>
                            <span>Yedek Güç:</span> {selectedDetail.yedekGuc}
                          </p>
                          <p>
                            <span>Birincil Güç:</span> {selectedDetail.birincilGuc}
                          </p>
                          <p>
                      ...
                      >
                        {pathname.includes("/portable-generator") ? "Satın Al" : "Katalog İndir"}
                      </Link>
                    </div>
                    <div className="row">
